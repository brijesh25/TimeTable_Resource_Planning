...
switch($formtype)
{
	case "new" : $action="web_new_allot.php";
	$heading="NEW";
	break;
	case "edit" : $action="web_edit_allot.php";
	$heading="EDIT";
	break;
	case "view" : $action="web_view_allot.php";
	$heading="VIEW";
}
?>
...
<div id="content">
<article>
<h1><?php echo $heading; ?> SUBJECT ALLOTMENT</h1>
<table>
<form name="suballot" action="<?php echo $action; ?>" method="POST" onsubmit = "return validate();">
